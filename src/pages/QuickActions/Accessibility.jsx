...
import { ChevronLeft, Sparkles, Accessibility as AccessibilityIcon } from 'lucide-react';
    ...
    <div className="qa-stub-root ltr-theme">
      ...
      <motion.div className="qa-stub-content" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <div className="qa-stub-card">
          <div className="qa-stub-icon-wrap"><AccessibilityIcon size={48} color="#FF4081" /></div>
          <h2>Accessibility Options</h2>
          <p>We believe health tracking is for everyone. Adjust text size, contrast, and voice-over options to ensure the app is fully accessible to you.</p>
        </div>
      </motion.div>
      <TouchBar />
    </div>
