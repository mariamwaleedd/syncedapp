    ...
    <div className="qa-stub-root ltr-theme">
      ...
      <motion.div className="qa-stub-content" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <div className="qa-stub-card">
          <div className="qa-stub-icon-wrap"><ShieldAlert size={48} color="#FF1744" /></div>
          <h2>Emergency Services</h2>
          <p>Get immediate access to local emergency services, SOS alerts, and critical health information for first responders.</p>
        </div>
      </motion.div>
      <TouchBar />
    </div>
