    ...
    <div className="qa-stub-root ltr-theme">
      ...
      <motion.div className="qa-stub-content" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <div className="qa-stub-card">
          <div className="qa-stub-icon-wrap"><Shield size={48} color="#00E676" /></div>
          <h2>Privacy Control</h2>
          <p>Control who sees your information. Manage data sharing preferences with medical providers, family members, and research partners.</p>
        </div>
      </motion.div>
      <TouchBar />
    </div>
