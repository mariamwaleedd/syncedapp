...
import { ChevronLeft, Sparkles, Pill } from 'lucide-react';
      ...
      >
        <div className="qa-stub-card">
          <div className="qa-stub-icon-wrap">
            <Pill size={48} color="#FF6D00" />
          </div>
          <h2>Medicine Tracker</h2>
          <p>Track your medications, schedules, and refill reminders in one place. Your health journey, organized.</p>
        </div>
      </motion.div>
