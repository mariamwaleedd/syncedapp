...
import { ChevronLeft, Sparkles, Bell } from 'lucide-react';
    ...
    <div className="qa-stub-root ltr-theme">
      ...
      <motion.div className="qa-stub-content" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <div className="qa-stub-card">
          <div className="qa-stub-icon-wrap"><Bell size={48} color="#FFD54F" /></div>
          <h2>Alert Preferences</h2>
          <p>Configure which health alerts and system notifications reach you. Control the timing and frequency of reminders for medications and upcoming appointments.</p>
        </div>
      </motion.div>
      <TouchBar />
    </div>
