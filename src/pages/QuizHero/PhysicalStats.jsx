...
const PhysicalStats = () => {
  ...
  useEffect(() => {
    const closeMenu = (e) => {
      if (heightRef.current && !heightRef.current.contains(e.target)) setShowHeightList(false);
      if (weightRef.current && !weightRef.current.contains(e.target)) setShowWeightList(false);
    };
        ...
        <div className="ps-stats-card">
          <div className="ps-select-group" ref={heightRef}>
            ...
            <div className="ps-custom-select" onClick={() => setShowHeightList(!showHeightList)}>
              <span className="ps-selected-val">{height}</span>
              <div className="ps-unit-flex">
                <span className="ps-unit-txt">cm</span>
          ...
          <div className="ps-select-group" ref={weightRef}>
            ...
            <div className="ps-custom-select" onClick={() => setShowWeightList(!showWeightList)}>
              <span className="ps-selected-val">{weight}</span>
              <div className="ps-unit-flex">
                <span className="ps-unit-txt">kg</span>
